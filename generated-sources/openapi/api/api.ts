...
export * from './dummyController.service';
import { DummyControllerService } from './dummyController.service';
export * from './dummyController.serviceInterface';
...
export const APIS = [AuthControllerService, BooksControllerService, ChaptersControllerService, DummyControllerService, SwaggerService, UsersControllerService];
